...
INSERT IGNORE INTO modes (name, display_name, description, icon_emoji) VALUES
...
INSERT IGNORE INTO achievements (name, description, badge_icon, criteria, xp_bonus, rarity) VALUES
...
-- Get mode IDs for fitness and hydration and insert quest templates
SET @fitness_mode_id = (SELECT id FROM modes WHERE name = 'fitness');
SET @hydration_mode_id = (SELECT id FROM modes WHERE name = 'hydration');

-- Fitness Quest Templates
INSERT IGNORE INTO quests (mode_id, title, description, quest_type, xp_reward, difficulty, requires_timer, timer_window_start, timer_window_end, readiness_check_enabled, readiness_check_time, is_mandatory) VALUES
...
SELECT 'Modes:' as 'Table', COUNT(*) as 'Count' FROM modes
UNION ALL
