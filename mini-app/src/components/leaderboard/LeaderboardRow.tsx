...
export const LeaderboardRow = memo(function LeaderboardRow({ entry, rank, isCurrentUser, timePeriod, index, trend = 'none' }: LeaderboardRowProps) {
  ...
  return (
    ...
    >
      ...
      <UserAvatar userId={entry.user_id} firstName={entry.first_name} username={entry.username} avatarId={entry.avatar_id} equippedItems={(entry as any).equipped_items} size="md" />
