export default {
  ...
  gifts: {
    ...
    received: "Received",
    send: "Send Gift",
    selectFriend: "Pick Friend",
    selectGift: "Pick Gift",
    confirm: "Confirm",
    from: "From",
    sent: "Gift Sent!",
    sendAnother: "Send Another",
    empty: "No gifts yet",
    emptyHint: "Gifts sent to you will appear here",
    noFriends: "Add friends to send them gifts",
    noGiftsAvailable: "No gifts available right now",
    sendingTo: "To:",
    back: "Back",
  ...
  subscription: {
    ...
    pageSubtitle: "Choose the plan that fits your goals",
    currentPlan: "Current Plan",
    choosePlan: "Choose a Plan",
    active: "Active",
    free: "Free",
    pricePerMonth: "{{price}} Stars / month",
    modesAvailable: "modes available",
    joinChannel: "Join Channel (Free)",
    autoRenew: "Auto-renew",
    expiresOn: "Expires {{date}}",
    manageSubscription: "Manage Subscription",
    refresh: "Refresh status",
    upgradeSuccess: "Upgrade Successful!",
    premiumActiveNote: "You have full access to all Premium features.",
    tiersUnavailable: "Plan information is temporarily unavailable.",
    billingNote: "Payments are processed via Telegram Stars. Subscriptions auto-renew monthly unless cancelled.",
  },
};
