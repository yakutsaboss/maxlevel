export default {
  ...
  content: {
    ...
    totalXp: "Total XP",
    feedEmpty: "Check back later for new content",
  ...
  reading: {
    ...
    noHistory: "No articles read yet",
    noBookmarks: "No bookmarks yet",
    daysStreak: "{{count}} days",
    xpFromContent: "XP from Content",
    articlesByCategory: "Articles by Category",
    quizScore: "Quiz: {{score}}",
    readOn: "Read on {{date}}",
  },
  recommendation: {
    todaysRead: "Today's Read",
    recommended: "Recommended for You",
    forYou: "Based on your interests",
