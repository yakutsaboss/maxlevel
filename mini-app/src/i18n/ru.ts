export default {
  ...
  onboarding: {
    ...
    modeMedication: "Лекарства",
    modeMedicationDesc: "Никогда не пропускайте приём с умными напоминаниями",
    modeHabits: "Привычки",
    modeHabitsDesc: "Формируйте ежедневные привычки и следите за прогрессом",
  ...
  dashboard: {
    ...
    medicationWidget: "Лекарства на сегодня",
    medicationProgress: "{{taken}}/{{total}} принято",
    nextMedication: "Далее: {{name}}",
  },
  quests: {
    title: "Задания",
  ...
  medication: {
    ...
    postponed: "Отложено",
    pending: "Ожидает",
    progress: "{{taken}}/{{total}} принято",
    nextDue: "Далее: {{name}} через {{time}}",
    noDue: "На сегодня всё выполнено!",
    emptyState: "Лекарства ещё не добавлены",
    emptyHint: "Нажмите +, чтобы добавить первое лекарство",
    adherence: "Соблюдение: {{rate}}%",
    history: "История",
    frequencyDaily: "Ежедневно",
    frequencyTwice: "Два раза в день",
    frequencyThree: "Три раза в день",
    frequencyWeekly: "Еженедельно",
    frequencyAsNeeded: "По необходимости",
    todayTab: "Сегодня",
    historyTab: "История",
    analyticsTab: "Аналитика",
    historyComingSoon: "Загрузка истории...",
    analyticsComingSoon: "Загрузка аналитики...",
  ...
  notifications: {
    ...
    filterAll: "Все",
    filterQuest: "Задания",
    filterAchievement: "Достижения",
    filterMedication: "Лекарства",
    filterStreak: "Серии",
    empty: "Пока нет уведомлений",
    streakMilestone: "\uD83D\uDD25 Серия {{days}} дней!",
  },
  analyticsPage: {
    title: "Аналитика",
  ...
  share: {
    toStory: "Поделиться в истории",
    success: "Опубликовано!",
    unavailable: "Публикация недоступна",
  },
  modeUnlock: {
  ...
  gifts: {
    ...
    selectFriend: "Выбор друга",
    selectGift: "Выбор подарка",
    confirm: "Подтверждение",
    from: "От",
    sent: "Подарок отправлен!",
    sendAnother: "Отправить ещё",
    empty: "Пока нет подарков",
    emptyHint: "Здесь появятся подарки, отправленные вам",
    noFriends: "Добавьте друзей, чтобы отправлять им подарки",
    noGiftsAvailable: "Сейчас нет доступных подарков",
    sendingTo: "Кому:",
    back: "Назад",
    message: "Личное сообщение",
    messagePlaceholder: "Добавить сообщение...",
    sending: "Отправка...",
  ...
  subscription: {
    pageTitle: "Подписка",
    pageSubtitle: "Выберите план, подходящий для ваших целей",
    currentPlan: "Текущий план",
    choosePlan: "Выбрать план",
    active: "Активен",
    free: "Бесплатно",
    pricePerMonth: "{{price}} Stars / месяц",
    modesAvailable: "режимов доступно",
    joinChannel: "Вступить в канал (бесплатно)",
    autoRenew: "Автопродление",
    expiresOn: "Истекает {{date}}",
    manageSubscription: "Управление подпиской",
    refresh: "Обновить статус",
    upgradeSuccess: "Подписка успешно обновлена!",
    premiumActiveNote: "У вас полный доступ ко всем функциям Премиум.",
    tiersUnavailable: "Информация о планах временно недоступна.",
    billingNote: "Оплата производится через Telegram Stars. Подписка автоматически продлевается ежемесячно, если не отменена.",
  },
};
